...
# Find old links and change it to new links
def replaceNotes(note_contents, old_note_filenames, note_name_pairs):
...
for note_path in new_note_paths:
    with open(note_path, 'r', encoding='UTF-8') as file:
        ...
        note_contents = replaceNotes(note_contents, old_note_filenames, note_name_pairs)
